...
urlpatterns = [
    ...
    url(r'^new-accounts/$', acc_views.AccountList_NEW1.as_view(), name='accounts'),
    ...
    url(r'^$', views.HomeView_NEW_Custom.as_view(), name='home'),
	...
	url(r'^login/$', views.LoginView_NEW_Custom, name='login'),
    url(r'^logout/$',
	...
	url(r'^register/$', views.RegisterView_NEW_Custom, name='RegisterView'),
    ...
    url(r'^accounts/$', acc_views.AccountList_NEW.as_view(), name='accounts1'),
